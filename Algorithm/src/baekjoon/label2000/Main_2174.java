...
//        }
            // 입력한 순서대로 로봇 번호 기입
//            for(int a = 1; a <= N; a++) {
//                map[robot.get(a)[1]][robot.get(a)[0]] = a;
//            }
...
//                System.out.println(Arrays.toString(robot.get(robot_NM)));
...
//                System.out.println(Arrays.toString(robot.get(robot_NM)));
    ...
    private static void printMap() {
        for(int a = B; a >= 1; a--) {            // A 최대 100 B 최대 100 ==> 최대 10000번
            for(int b = 1; b <= A; b++) {
