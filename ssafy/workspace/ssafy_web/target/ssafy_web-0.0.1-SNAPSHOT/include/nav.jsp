...
<nav id="sidebar-wrapper">
	...
	<c:if test="${user_session != null}">
        ...
        <li class="sidebar-nav-item nav-fixed"><a href="${root}/jsp/member/findPw.jsp">비밀번호 찾기</a></li>
    	...
    	<li class="sidebar-nav-item nav-fixed"><a href="${root}/jsp/board/list.jsp">공지사항</a></li>
    ...
    <c:if test="${user_session == null}">
	    <ul class="sidebar-nav">
	        <li class="sidebar-brand"><a href="#page-top">구해줘 홈즈!</a></li>
	        <li class="sidebar-nav-item"><a href="${root}/jsp/member/register.jsp">회원가입</a></li>
	        <li class="sidebar-nav-item nav-fixed"><a href="${root}/jsp/member/login.jsp">로그인</a></li>
	    </ul>
   	</c:if>
</nav>